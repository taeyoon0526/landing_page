...
function setLanguage(lang) {
  document.querySelector('#intro h1').textContent = content[lang].introTitle;
  document.querySelector('#intro p').textContent = content[lang].introDesc;
  document.querySelector('#skills h2').textContent = content[lang].skillsTitle;
  document.querySelector('#contact h2').textContent = content[lang].contactTitle;
  const navLinks = document.querySelectorAll('#navbar a');
  navLinks.forEach((a, i) => a.textContent = content[lang].nav[i]);
  langToggle.textContent = content[lang].langBtn;
}
